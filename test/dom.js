...
var rolesMap_1 = createCommonjsModule(function (module, exports) {
  ...
  (0, _forEach.default)(
    ...
    (0, _forEach.default)(roleSet).call(
      roleSet,
  ...
  (0, _forEach.default)(rolesMap).call(
    rolesMap,
    function (roleDefinition, name) {
...
function getLabels$1(container, element, _temp) {
  ...
  return labelsId.length
    ...
    : Array.from(getRealLabels(element)).map(function (label) {
        ...
        var formControlSelector =
          "button, input, meter, output, progress, select, textarea";
        var labelledFormControl = Array.from(
          label.querySelectorAllWithShadowDOM(formControlSelector)
...
function buildElementRoleList(elementRolesMap) {
  ...
  for (
    var _iterator2 = _createForOfIteratorHelperLoose(elementRolesMap.entries()),
      _step2;
      ...
      return roles.reduce(function (rolesAcc, role) {
        ...
        return Array.isArray(rolesAcc[role])
          ...
          : _extends(
              {},
              rolesAcc,
              ((_extends3 = {}), (_extends3[role] = [node]), _extends3)
            );
      }, acc);
    }, {});
}
...
function waitFor(callback, _ref) {
  var _ref$container = _ref.container,
    ...
    timeout =
      _ref$timeout === void 0 ? getConfig().asyncUtilTimeout : _ref$timeout,
                  ...
                  case 0:
                    ...
                    checkCallback = function _checkCallback() {
                      ...
                      try {
                        ...
                        if (
                          typeof (result == null ? void 0 : result.then) ===
                          "function"
                        ) {
...
var wrapSingleQueryWithSuggestion = function wrapSingleQueryWithSuggestion(
  query,
  queryAllByName,
  variant
) {
...
var wrapAllByQueryWithSuggestion = function wrapAllByQueryWithSuggestion(
  query,
  queryAllByName,
  variant
) {
      ...
      var uniqueSuggestionMessages = [].concat(
        new Set(
          els.map(function (element) {
            ...
            return (_getSuggestedQuery = getSuggestedQuery(element, variant)) ==
              null
              ? void 0
...
function queryAllByRole(container, role, _temp) {
  ...
  if (expanded !== undefined) {
    ...
    // guard against unknown roles
    if (
      ((_allRoles$get4 = lib.roles.get(role)) == null
        ? void 0
        : _allRoles$get4.props["aria-expanded"]) === undefined
    ) {
      throw new Error(
    ...
    if (typeof dataTransferValue === "object") {
      ...
      if (typeof window.DataTransfer === "function") {
        Object.defineProperty(event, dataTransferKey, {
          value: Object.getOwnPropertyNames(dataTransferValue).reduce(function (
            acc,
            propName
          ) {
